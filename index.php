		...
		<div class="row">
			...
			<div class="col-md-6 col-xs-12">
				<?php
					...
					{
						echo "<center><img width='511' height='700' src='./zosia.jpg'></img></center>";
					}
				?>
			</div>
  					...
  					<div class="card-body">
  						...
  						<table class="table table-hover table-dark table-responsive">
  							...
  							<tbody>
    							<tr>
      								<th scope="row">1</th>
      								<td>Zbigniew Stonoga</td>
     								<td>Nie warto było</td>
    							</tr>
								<tr>
      								<th scope="row">2</th>
      								<td>John Cena</td>
...
<footer class="text-center">
	<nav class="container navbar navbar-expand-lg fixed-bottom navbar-dark bg-dark mb-2 rounded">
  		<a class="navbar-brand" href="">(C) Mateusz Brożek, UEK 2017</a>
	</nav>
</footer>
